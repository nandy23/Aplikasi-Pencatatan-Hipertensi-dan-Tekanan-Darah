...
class Rt1_model extends CI_model
{

    public function all_pasien()
    {
        $hsl = $this->db->query("SELECT * FROM rt1");
        return $hsl;
    }

    public function all_periksa()
    {
        $hsl = $this->db->query("SELECT * FROM pemeriksaan");
        return $hsl;
    }

    public function all_periksa_byId($id)
    {
        $hsl = $this->db->query("SELECT * FROM rt1 WHERE id = '$id'");
        return $hsl;
    }
    ...
    {
        $hsl = $this->db->query("SELECT * FROM pemeriksaan WHERE id = '$id'");
        return $hsl;
    }

    public function pasien_byNama($nama_warga)
    {
        $hsl = $this->db->query("SELECT * FROM pemeriksaan WHERE nama_warga = '$nama_warga' ORDER BY tanggal_periksa ASC");
        return $hsl;
    }
    ...
    public function ubah()
    {
        ...
        $this->db->update('rt1', $data);
        $this->db->where('nama_warga', $this->input->post('nama_warga1'));
        $this->db->update('pemeriksaan', $data1);
    }
