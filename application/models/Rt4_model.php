...
class Rt4_model extends CI_model
{

    public function all_pasien()
    {
        $hsl = $this->db->query("SELECT * FROM rt4");
        return $hsl;
    }

    public function all_periksa()
    {
        $hsl = $this->db->query("SELECT * FROM pemeriksaan_rt4");
        return $hsl;
    }

    public function all_periksa_byId($id)
    {
        $hsl = $this->db->query("SELECT * FROM rt4 WHERE id = '$id'");
        return $hsl;
    }



    public function rt4_byId($id)
    {
        $hsl = $this->db->query("SELECT * FROM rt4 WHERE id = '$id'");
        return $hsl;
    }
    ...
    {
        $hsl = $this->db->query("SELECT * FROM pemeriksaan_rt4 WHERE id = '$id'");
        return $hsl;
    }

    public function pasien_byNama($nama_warga)
    {
        $hsl = $this->db->query("SELECT * FROM pemeriksaan_rt4 WHERE nama_warga = '$nama_warga' ORDER BY tanggal_periksa ASC");
        return $hsl;
    }
    ...
    public function ubah()
    {
        ...
        $this->db->update('rt4', $data);
        $this->db->where('nama_warga', $this->input->post('nama_warga1'));
        $this->db->update('pemeriksaan_rt4', $data1);
    }
    ...
    public function simpan_periksa()
    {
        ...
        $this->db->insert('pemeriksaan_rt4', $data);
    }
    ...
    public function ubah_periksa()
    {
        ...
        $this->db->where('id', $this->input->post('id'));
        $this->db->update('pemeriksaan_rt4', $data);
        // $this->db->where('nama_warga', $this->input->post('nama_warga1'));
        // $this->db->update('rt4', $data1);
    }
    ...
    public function hapus_periksa()
    {
        ...
        $this->db->where('id', $this->input->post('id'));
        $this->db->delete('pemeriksaan_rt4');
    }
}
