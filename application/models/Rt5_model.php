...
class Rt5_model extends CI_model
{

    public function all_pasien()
    {
        $hsl = $this->db->query("SELECT * FROM rt5");
        return $hsl;
    }

    public function all_periksa()
    {
        $hsl = $this->db->query("SELECT * FROM pemeriksaan_rt5");
        return $hsl;
    }

    public function all_periksa_byId($id)
    {
        $hsl = $this->db->query("SELECT * FROM rt5 WHERE id = '$id'");
        return $hsl;
    }



    public function rt5_byId($id)
    {
        $hsl = $this->db->query("SELECT * FROM rt5 WHERE id = '$id'");
        return $hsl;
    }
    ...
    {
        $hsl = $this->db->query("SELECT * FROM pemeriksaan_rt5 WHERE id = '$id'");
        return $hsl;
    }

    public function pasien_byNama($nama_warga)
    {
        $hsl = $this->db->query("SELECT * FROM pemeriksaan_rt5 WHERE nama_warga = '$nama_warga' ORDER BY tanggal_periksa ASC");
        return $hsl;
    }
    ...
    public function ubah()
    {
        ...
        $this->db->update('rt5', $data);
        $this->db->where('nama_warga', $this->input->post('nama_warga1'));
        $this->db->update('pemeriksaan_rt5', $data1);
    }
    ...
    public function simpan_periksa()
    {
        ...
        $this->db->insert('pemeriksaan_rt5', $data);
    }
    ...
    public function ubah_periksa()
    {
        ...
        $this->db->where('id', $this->input->post('id'));
        $this->db->update('pemeriksaan_rt5', $data);
        // $this->db->where('nama_warga', $this->input->post('nama_warga1'));
        // $this->db->update('rt5', $data1);
    }
    ...
    public function hapus_periksa()
    {
        ...
        $this->db->where('id', $this->input->post('id'));
        $this->db->delete('pemeriksaan_rt5');
    }
}
