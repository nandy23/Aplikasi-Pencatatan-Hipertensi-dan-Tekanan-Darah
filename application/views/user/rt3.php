...
<div class="main">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align:center;">
                                                            ...
                                                            <a class="btn" href="<?= base_url('rt3/lap_pasien_hasil/'); ?><?= encrypt_url($p['id']); ?>"><span class="fas fa-print"></span></a>
            ...
            <div class="modal-content">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form class="form-horizontal" action="<?= base_url('rt3/simpan'); ?>" method="post" enctype="multipart/form-data">
    ...
    <!--EDIT PASIEN-->
    <?php foreach ($rt3->result_array() as $p) : ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <form class="form-horizontal" action="<?= base_url('rt3/ubah'); ?>" method="post" enctype="multipart/form-data">
                                        <div class="modal-body">
            ...
            <div class="modal-content">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form class="form-horizontal" action="<?php echo base_url('rt3/hapus'); ?>" method="post" enctype="multipart/form-data">
                                    <div class="modal-body">
                                        <input type="hidden" name="id" value="<?= $p['id']; ?>" />
