<div class="main" id="pasienhasil">
									...
									<div class="table-responsive">
										<table class="table table-striped" id="example1" style="font-size:13px;">
											...
											<tbody>
												<?php
												$no = 0;
												foreach ($rt1_byNama->result_array() as $p) :
													$no++;
												?>
													<tr>
														<td><?= $no; ?></td>
	...
	<!--TAMBAH PASIEN-->
	<?php foreach ($rt1_byNama1->result_array() as $p) : ?>
				...
				<div class="modal-content">
					...
					<div class="panel">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12">
									<form class="form-horizontal" action="<?= base_url('rt1/simpan_periksa'); ?>" method="post" enctype="multipart/form-data">
	...
	<!--EDIT PASIEN-->
	<?php foreach ($rt1_byNama->result_array() as $p) : ?>
				...
				<div class="modal-content">
					...
					<div class="panel">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12">
									<form class="form-horizontal" action="<?= base_url('rt1/ubah_periksa'); ?>" method="post" enctype="multipart/form-data">
										<div class="modal-body">
			...
			<div class="modal-content">
				...
				<div class="panel">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<form class="form-horizontal" action="<?php echo base_url('rt1/hapus_periksa'); ?>" method="post" enctype="multipart/form-data">
									<div class="modal-body">
										<input type="hidden" name="id" value="<?= $p['id']; ?>" />
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="modal-header">
							<h3 class="modal-title" id="ModalKategoriRendah">Diabetes</h3>
						</div>
					</div>
